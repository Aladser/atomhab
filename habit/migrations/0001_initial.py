    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('place', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='habits', to='habit.place', verbose_name='Место')),
                ('reward', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='habits', to='habit.reward', verbose_name='Вознаграждение')),
            ],
            options={
